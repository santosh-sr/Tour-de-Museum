...
function fetchdata(museum, clusterType, clusterVal){
  ...
  if(typeof clusterType != 'undefined'){
    if(clusterType == 'Artist'){
      query = "select * from painting p where p.museum_name = '" + museum + "' and p.artist_name like '%" + clusterVal + "%'";
      ...
      query = "select * from painting p where p.museum_name = '" + museum + "' and p.date = '" + clusterVal + "'";
      ...
      query = "select * from painting p where p.museum_name = '" + museum + "' and p.medium like '%" + clusterVal + "%'";
      ...
      query = "select * from painting p where p.museum_name = '" + museum + "' and p.title like '%" + clusterVal + "%'";
   ...
   /* $.ajax({
                ...
                success: function(data){
                    ...
                    for(var jdata in jsonData){
                      ...
                      elem.src = jsonData[jdata].imageURL;
  ...
  function textSearch(){
    ...
    fetchdata(museumName, clusterType, searchText);
    alert("test success!");
  }
