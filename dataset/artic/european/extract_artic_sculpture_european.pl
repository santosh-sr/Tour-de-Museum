...
$url = "http://www.artic.edu/aic/collections/artwork/category/10?filters=has_image%3Atrue+collection_category%3A%220/European+Painting+and+Sculpture%22+object_type_s%3ASculpture";
...
open (MYFILE, '>data_artic_sculpture_european.txt');
print MYFILE "{\n";
...
#added this to get rid of quotes
		$title[0] =~ s/"//g;
		@title = $title[0];
	...
	$url = "http://www.artic.edu/aic/collections/artwork/category/10?page=". $j . "&filters=has_image%3Atrue+collection_category%3A%220/European+Painting+and+Sculpture%22+object_type_s%3ASculpture";
	#http://www.artic.edu/aic/collections/artwork/department/21?page=". $j . "&filters=has_image%3Atrue+collection_category%3A0/American+object_type_s%3ASculpture
	#http://www.artic.edu/aic/collections/artwork/category/10?page=". $j . "&filters=has_image%3Atrue+collection_category%3A%220/European+Painting+and+Sculpture%22+object_type_s%3ASculpture
	$j++;
}
