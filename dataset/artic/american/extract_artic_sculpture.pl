...
$url = "http://www.artic.edu/aic/collections/artwork/department/21?filters=has_image%3Atrue+collection_category%3A0/American+object_type_s%3ASculpture";
...
open (MYFILE, '>data_artic_sculpture.txt');
print MYFILE "{\n";
...
#added this to get rid of quotes
	...
	$url = "http://www.artic.edu/aic/collections/artwork/department/21?page=". $j . "&filters=has_image%3Atrue+collection_category%3A0/American+object_type_s%3ASculpture";
