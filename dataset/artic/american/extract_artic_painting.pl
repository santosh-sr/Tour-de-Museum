...
$url = "http://www.artic.edu/aic/collections/artwork/department/21?filters=has_image%3Atrue+object_type_s%3APainting+collection_category%3A0/American";
...
open (MYFILE, '>data_artic_paintings.txt');
print MYFILE "{\n";
...
while ($j <=9) {
	...
	$url = "http://www.artic.edu/aic/collections/artwork/department/21?page=". $j . "&filters=has_image%3Atrue+object_type_s%3APainting+collection_category%3A0/American";
	$j++;
}
