...
$url = "http://www.dia.org/art/search-collection.aspx?searchType=new&department=European+Sculpture+and+Dec+Arts&artist=&nationality=&medium=&objectNumber=&keyword=&date_from=&date_to=&action=Search+Art+at+the+DIA";
...
while ($j <= 20) {
	...
	$j++;
	$url = "http://www.dia.org/art/search-collection.aspx?artist=&classification=&department=European+Sculpture+and+Dec+Arts&objectnumber=&keyword=&medium=&nationality=&date_from=&date_to=&the_Page=" . $j . "&all_items=";
	#http://www.dia.org/art/search-collection.aspx?artist=&classification=&department=European+Sculpture+and+Dec+Arts&objectnumber=&keyword=&medium=&nationality=&date_from=&date_to=&the_Page=1&all_items=
}
